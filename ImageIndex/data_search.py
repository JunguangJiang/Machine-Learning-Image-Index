...
# #直接在这里改路径
# prefix="../../data/"
# file_list = get_file_list(prefix+'image/imagelist.txt')
# x = load_feature(prefix+'abstract_features/label_feature.txt')
# y = labelize_image(file_list)
# balltree = setup_ball_tree(x,'ball_tree.txt')
# balltree = read_ball_tree('ball_tree.txt')
# similar_list,precision = query_image(file_list,prefix+'image/n03877845_1184.JPEG',balltree,x,y,10)
# print(similar_list)
# print(precision)
#
